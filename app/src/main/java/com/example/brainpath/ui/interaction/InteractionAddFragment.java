        ...
        builder.setPositiveButton("Add", (dialog, which) -> {
            ...
            db.collection(type + "s")  // Adds to "friends", "groups", or "communities" collection
                    ...
                    .addOnSuccessListener(documentReference -> {
                        Toast.makeText(requireContext(), capitalize(type) + " added successfully!", Toast.LENGTH_SHORT).show();
                        ...
                        db.collection("users")
                                ...
                                .addOnFailureListener(e -> {
                                    Toast.makeText(requireContext(), "Error updating current user's friend list: " + e.getMessage(), Toast.LENGTH_SHORT).show();
                                });
