...
public class InteractionAddFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        View view = inflater.inflate(R.layout.activity_interaction_add, container, false);
        ...
        Button btnAddCommunity = view.findViewById(R.id.btnAddCommunity);
                                ...
                                .addOnSuccessListener(aVoid -> {
                                    db.collection("users")
                                            ...
                                            .addOnFailureListener(e -> {
                                                Toast.makeText(getContext(), "Error adding friend to friend's list: " + e.getMessage(), Toast.LENGTH_SHORT).show();
                                            });
                                })
                                .addOnFailureListener(e -> {
                                    Toast.makeText(getContext(), "Error adding friend to current user's list: " + e.getMessage(), Toast.LENGTH_SHORT).show();
                                });
                    }
                })
                .addOnFailureListener(e -> {
        ...
        db.collection("groups")
                ...
                .addOnSuccessListener(documentReference -> {
                    ...
                    db.collection("groups")
                                        ...
                                        .addOnSuccessListener(userDocument -> {
                                            if (userDocument.exists()) {
                                                ...
                                                if (friendIds != null && !friendIds.isEmpty()) {
                                                    ...
                                                    Toast.makeText(getContext(), "You have no friends to add to the group.", Toast.LENGTH_SHORT).show();
                                                }
                                            }
                                        })
                                        .addOnFailureListener(e -> {
                            ...
                            .addOnFailureListener(e -> {
                                Toast.makeText(getContext(), "Error adding user to group: " + e.getMessage(), Toast.LENGTH_SHORT).show();
                            });
                })
                .addOnFailureListener(e -> {
    ...
    private void showFriendSelectionDialog(List<String> friendIds, String groupId) {
        ...
        for (String friendId : friendIds) {
            db.collection("users")
                    ...
                    .addOnFailureListener(e -> {
                        Toast.makeText(getContext(), "Error fetching friend data: " + e.getMessage(), Toast.LENGTH_SHORT).show();
                    });
        }
    }
        ...
        builder.setTitle("Select Friends to Add to the Group")
                ...
                .setPositiveButton("Add", (dialog, which) -> {
                    ...
                    db.collection("groups")
                            ...
                            .addOnSuccessListener(aVoid -> {
                                Toast.makeText(getContext(), "Friends added to the group!", Toast.LENGTH_SHORT).show();
                            })
                            .addOnFailureListener(e -> {
                                Toast.makeText(getContext(), "Error adding friends to group: " + e.getMessage(), Toast.LENGTH_SHORT).show();
                            });
                })
    ...
    private void addCommunity(String communityName) {
        ...
        db.collection("groups")
                ...
                .addOnSuccessListener(queryDocumentSnapshots -> {
                    if (queryDocumentSnapshots.isEmpty()) {
                        Toast.makeText(getContext(), "You are not part of any groups", Toast.LENGTH_SHORT).show();
                        return;
                    }
                    ...
                    AlertDialog.Builder groupSelectionBuilder = new AlertDialog.Builder(requireContext());
                    groupSelectionBuilder.setTitle("Select Groups to Add")
                            ...
                            .setPositiveButton("Create Community", (dialog, which) -> {
                                ...
                                db.collection("communities")
                                        ...
                                        .addOnFailureListener(e -> {
                                            Toast.makeText(getContext(), "Error creating community: " + e.getMessage(), Toast.LENGTH_SHORT).show();
                                        });
                            })
                            .setNegativeButton("Cancel", (dialog, which) -> dialog.dismiss());
                ...
                .addOnFailureListener(e -> {
                    Toast.makeText(getContext(), "Error retrieving groups: " + e.getMessage(), Toast.LENGTH_SHORT).show();
                });
    }
